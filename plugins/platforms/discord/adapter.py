...
_NATIVE_SLASH_COMMANDS: tuple = (
    ...
    ("resume", "Resume a previously-named session",
     ...
     "/resume {name}", None),
    ("sessions", "Browse sessions (all / full / search / project)",
     (("args", str, "", "Empty for this chat, 'all' for every surface, 'project' to group by project, 'search <q>'.", None),),
     "/sessions {args}", None),
    ("project", "List Hermes projects or create one",
     (("args", str, "", "'list' (default) or 'create <name>' — the folder is made under your projects root.", None),),
     "/project {args}", None),
