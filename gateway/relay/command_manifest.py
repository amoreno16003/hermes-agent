...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("sessions", "Browse sessions (all / full / search / project)",
             _opt("args", "all | full | search <q> | project [slug]")),
        _cmd("project", "List Hermes projects or create one",
             _opt("args", "list | create <name>")),
